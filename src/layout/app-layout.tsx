...
export default function AppLayout({ children, breadcrumbs, ...props }: AppLayoutProps) {
    ...
    const data = {
        ...
        footer_link: import.meta.env.VITE_FOOTER_LINK ?? 'https://laravel.com',
        footer_text: import.meta.env.VITE_FOOTER_TEXT ?? 'Laravel',
    };
            ...
            <AppLayoutTemplate breadcrumbs={breadcrumbs} {...props}>
                ...
                <footer className="w-full border-t py-6">
                    <div className="container mx-auto flex flex-col space-y-2 p-4 px-4 md:flex-row md:items-center md:justify-between md:space-y-0">
                        ...
                        <p className="text-muted-foreground text-sm">
                            Developed by <span><Link to={data.footer_link}>{data.footer_text}</Link></span>
                        </p>
                    </div>
                </footer>
            </AppLayoutTemplate>
