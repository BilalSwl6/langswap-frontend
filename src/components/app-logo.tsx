...
export default function AppLogo() {
    // const { logo } = usePage<SharedData>().props.settings;
    // const { name } = usePage<SharedData>().props;
    // const data = usePage<SharedData>().props.settings;
    // console.log(data)
    return (
        <>
            <div className="dark:bg-white text-sidebar-primary-foreground flex aspect-square size-8 items-center justify-center rounded-md">
                ...
                {/* <img src={logo ? `${logo}` : '/logo.png'} alt="Logo" className="size-7 fill-current text-white dark:text-black" /> */}
            </div>
